public class App {
    public static void main(String[] args){
        Item dripCoffee = new Item("drip coffee", 1);
        Item latte = new Item("latte", 4);
        Item capuccino = new Item("capuccino", 3);
        Item mocha = new Item("mocha", 2);

        Order order1 = new Order();
        Order order2 = new Order();

        Order order3 = new Order("ezz");
        Order order4 = new Order("Ahmed");
        Order order5 = new Order("amer");
